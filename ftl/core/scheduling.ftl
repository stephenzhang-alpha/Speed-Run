...
scheduling-update-soon = LSAT Prep 2.1 comes with a new scheduler, which fixes a number of issues that previous LSAT Prep versions had. Updating to it is recommended.
