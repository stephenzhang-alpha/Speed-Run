...
addons-failed-to-load2 =
    ...
    They may need to be updated to support this version of LSAT Prep. Click the { addons-check-for-updates } button
...
addons-changes-will-take-effect-when-anki = Changes will take effect when LSAT Prep is restarted.
...
addons-download-complete-please-restart-anki-to = Download complete. Please restart LSAT Prep to apply changes.
...
addons-install-anki-addon = Install LSAT Prep add-on
...
addons-invalid-code-or-addon-not-available = Invalid code, or add-on not available for your version of LSAT Prep.
...
addons-packaged-anki-addon = Packaged LSAT Prep Add-on
...
addons-please-restart-anki-to-complete-the = <b>Please restart LSAT Prep to complete the installation.</b>
...
addons-this-addon-is-not-compatible-with = This add-on is not compatible with your version of LSAT Prep.
...
addons-unable-to-update-or-delete-addon = Unable to update or delete add-on. Please start LSAT Prep while holding down the shift key to temporarily disable add-ons, then try again.  Debug info: { $val }
